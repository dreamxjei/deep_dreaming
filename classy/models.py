...
def ResNeXt101_pretrained(n_classes, freeze=True):
...
def wide_resnet101_pretrained(n_classes, freeze=True):
...
def efficientnet_b7_pretrained(n_classes, freeze=True):
...
def regnet_x_32gf_pretrained(n_classes, freeze=True):
