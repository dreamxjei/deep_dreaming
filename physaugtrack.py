# physical augmentation track by mxj
...
def affine_image(img_path, iteration, rotate=False):
    ...
    # tf_augment = transform.AffineTransform(scale=scale, rotation=np.deg2rad(rotation)
    # translation=translation, shear=np.deg2rad(shear))
